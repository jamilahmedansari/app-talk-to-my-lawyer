-- Deploy Functions, RLS Policies, and Helpers to Supabase
-- This is a safe incremental deployment that won't break existing schema

-- ====================================
-- 1) CREATE HELPER ENUMS (IF NOT EXISTS)
-- ====================================
...
-- letters: add completed_at field
...
-- ====================================
-- 9) SUBSCRIPTION TRIGGER (commission + coupon)
-- ====================================
...
BEGIN
  ...
  RAISE NOTICE '  - Enums: user_role, letter_status, sub_status, commission_status';
  RAISE NOTICE '  - Functions: is_admin(), is_employee(), check_subscription_limits()';
  RAISE NOTICE '  - Tables: user_roles, employee_coupons, commissions';
  RAISE NOTICE '  - RLS Policies: All tables secured';
  RAISE NOTICE '  - Triggers: Signup, Subscription, Updated timestamps';
